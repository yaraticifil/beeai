      ...
      >
        ...
        >
          ...
          <View style={styles.signupLinkContainer}>
            <Text style={styles.signupLinkText}>Henüz bir kovanın yok mu?</Text>
            <Pressable onPress={() => router.push("/(auth)/signup")}>
              <Text style={styles.signupLinkAction}> Kovana Katıl</Text>
            </Pressable>
          </View>

          <View style={styles.legalFooter}>
            <Pressable><Text style={styles.legalLink}>KVKK</Text></Pressable>
...
const styles = StyleSheet.create({
  ...
  footer: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, marginTop: 10, marginBottom: 20 },
  footerText: { fontSize: 12, fontFamily: "Poppins_400Regular", color: "rgba(255,255,255,0.4)" },
  signupLinkContainer: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 10 },
  signupLinkText: { fontSize: 13, fontFamily: 'Poppins_400Regular', color: 'rgba(255,255,255,0.6)' },
  signupLinkAction: { fontSize: 13, fontFamily: 'Poppins_700Bold', color: Colors.gold },
  legalFooter: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 10, marginTop: 40, opacity: 0.4 },
  legalLink: { fontSize: 11, fontFamily: 'Poppins_400Regular', color: Colors.white, textDecorationLine: 'underline' },
  legalDivider: { fontSize: 11, color: Colors.white },
});
